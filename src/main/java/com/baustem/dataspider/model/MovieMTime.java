...
@HelpUrl("http://movie.mtime.com/all/list/*")
public class MovieMTime implements AfterExtractor {
	...
	public String downPoster(String url){
		try {
			...
			File store = new File("D:/poster/movie/"+System.currentTimeMillis()+".jpg");
	...
	public String toString() {
		return "MovieMTime [name=" + name + ", birthDay=" + birthDay + ", type="
